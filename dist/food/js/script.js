...
function cards() {
  ...
  axios.get('http://localhost:3000/menu').then(data => {
    data.data.forEach(({
      ...
      !img ? console.log('empty info') : new MenuCard(img, altimg, title, descr, price, '.menu__item_container').render();
    });
  });
...
function forms(timeoutModalToShow) {
  ...
  function bindpostData(form) {
    form.addEventListener('submit', e => {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_3__["postData"])('http://localhost:3000/menu', json).then(data => {
        console.log(data);
  ...
  function showThanksModal(message) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_2__["openModal"])('.modal', timeoutModalToShow);
